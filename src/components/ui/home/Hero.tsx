  ...
  return (
    <section className="relative isolate h-[320px] overflow-hidden sm:h-[442px] lg:h-[736px]">
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="absolute -top-[77px] -left-[50px] z-0 h-[237px] w-[325px] rounded-full bg-[#221158] opacity-100 sm:-top-[133px] sm:-left-[87px] sm:h-[411px] sm:w-[563px] lg:-top-[258px] lg:-left-[169px] lg:h-[795px] lg:w-[1090px]" />
        <div
